...
<head>
    ...
    @include('template.main.lms.head')
...
<body id="page-top" cz-shortcut-listen="true">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <!-- TopBar -->
                @include('template.main.lms.topbar')
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;
                            <script> document.write(new Date().getFullYear()); </script> DIGIYOK. All Rights
                            Reserved.</b>
                        </span>
                    </div>
                </div>
    ...
    @include('template.main.lms.plugin')
